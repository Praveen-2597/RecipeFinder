...
class App extends Component {
  ...
  findRecipe = async() =>{
    ...
    console.log(this.state.srchdata)
    const response = await fetch(`https://www.themealdb.com/api/json/v1/1/search.php?s=${this.state.srchdata}`);
...
getIngredients = (value, index) => {
  ...
  render() {   
    ...
    <div id="header">
         ...
         <center><input onChange={()=>this.setName(event)} value={this.state.srchdata} placeholder="Enter the Name of the Dish"/>
    ...
    <div id="container">
      ...
      <div id="header1">
         <div></div>
         <div><h1 id="main">{this.state.recipearr.strMeal}</h1></div>
      ...
      <div id="description">
        ...
        <div id="right">
         <i>Category of the Meal - </i>{this.state.recipearr.strCategory}
         <br/>
         <i>Area of the Meal - </i>{this.state.recipearr.strArea}
         <br/>
         <br/>
         ...
         <div id="recipe">
         {this.state.recipearr.strInstructions}
         </div>
